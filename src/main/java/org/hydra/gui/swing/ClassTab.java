...
public class ClassTab extends JPanel {
    ...
    protected void applyChanges() {
        String renameScript = this.classInfoPanel.getChangeScript()
                              + this.fieldModel.getChangeScript()
                              + this.methodModel.getChangeScript();
        System.out.println(renameScript);
        // TODO apply the changes script and reload all jar? or related class?
    }
